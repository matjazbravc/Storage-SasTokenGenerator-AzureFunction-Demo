...
namespace StorageSasTokenGeneratorAzureFunctionDemo.Services.Extensions
{
    ...
    public static class Int32Extensions
    {
        ...
        /// <summary>
        ///     Throws an <see cref="ArgumentOutOfRangeException" /> if the given value is less than or equal to the given
        ///     comparer.
        /// </summary>
        /// <param name="value">Value to check.</param>
        /// <param name="comparer">Value to compare.</param>
        /// <returns>
        ///     Returns the original value, if the value is greater than the comparer; otherwise throws an
