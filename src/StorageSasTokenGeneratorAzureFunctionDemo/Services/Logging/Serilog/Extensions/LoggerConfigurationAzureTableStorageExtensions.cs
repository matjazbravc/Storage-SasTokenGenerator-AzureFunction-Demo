...
using StorageSasTokenGeneratorAzureFunctionDemo.Services.Logging.Serilog.Services;
using StorageSasTokenGeneratorAzureFunctionDemo.Services.Logging.Serilog.Sinks;

namespace StorageSasTokenGeneratorAzureFunctionDemo.Services.Logging.Serilog.Extensions
{
    /// <summary>
